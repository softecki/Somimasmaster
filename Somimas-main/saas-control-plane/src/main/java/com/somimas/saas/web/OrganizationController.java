...
public class OrganizationController {
    ...
    public List<OrganizationResponse> listOrganizations() {
        return organizationService.listForIdentity(SecurityUtils.currentIdentityId());
    }

    @GetMapping("/{id}")
    public OrganizationResponse getOrganization(@PathVariable("id") Long organizationId) {
