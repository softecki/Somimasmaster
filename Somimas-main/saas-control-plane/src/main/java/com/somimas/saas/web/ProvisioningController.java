...
@RestController
@RequestMapping("/organizations/{id}/provisioning")
public class ProvisioningController {
    ...
    @GetMapping
    public ProvisioningStatusResponse getProvisioningStatus(@PathVariable("id") Long organizationId) {
        organizationAuthorizationService.requireMembership(SecurityUtils.currentIdentityId(), organizationId);
        return provisioningService.getStatusForOrganization(organizationId);
    }
}
