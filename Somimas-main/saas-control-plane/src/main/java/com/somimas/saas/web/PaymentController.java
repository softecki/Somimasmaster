...
import com.somimas.saas.payment.PaymentService;
...
@RestController
@RequestMapping("/organizations/{id}/payments")
public class PaymentController {
    ...
    public CheckoutSessionResponse createCheckoutSession(@PathVariable("id") Long organizationId,
        ...
        return paymentService.createCheckoutSession(organizationId, request);
    }
}
