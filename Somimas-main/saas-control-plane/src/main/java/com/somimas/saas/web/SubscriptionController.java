...
@RestController
@RequestMapping("/organizations/{id}/subscription")
public class SubscriptionController {
    ...
    @GetMapping
    public SubscriptionResponse getSubscription(@PathVariable("id") Long organizationId) {
        organizationAuthorizationService.requireMembership(SecurityUtils.currentIdentityId(), organizationId);
        return subscriptionService.getForOrganization(organizationId);
    }
}
