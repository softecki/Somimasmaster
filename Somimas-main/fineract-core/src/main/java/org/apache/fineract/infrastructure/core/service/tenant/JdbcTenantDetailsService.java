...
public class JdbcTenantDetailsService implements TenantDetailsService {
    ...
    /**
     * Evicts a single tenant from the {@code tenantsById} cache after registry changes.
     */
    @Override
    @CacheEvict(value = "tenantsById", key = "#tenantIdentifier")
    public void evictTenantFromCache(final String tenantIdentifier) {
        // cache eviction handled by annotation
    }

    /**
     * Clears the entire {@code tenantsById} cache.
     */
    @Override
    @CacheEvict(value = "tenantsById", allEntries = true)
