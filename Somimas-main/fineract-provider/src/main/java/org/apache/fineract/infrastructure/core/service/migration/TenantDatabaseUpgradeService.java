...
public class TenantDatabaseUpgradeService implements InitializingBean, TenantDatabaseUpgradeServiceFacade {
     ...
     */
    /**
     * Upgrade a single tenant database schema (Liquibase).
     *
     * @param tenant tenant to upgrade
     * @throws LiquibaseException when migration fails
     */
    public void upgradeTenant(FineractPlatformTenant tenant) throws LiquibaseException {
        upgradeIndividualTenant(tenant);
    }

    /**
     * Upgrade a single tenant database schema by identifier.
     *
     * @param tenantIdentifier tenant identifier
     * @throws LiquibaseException when migration fails
     */
    @Override
    public void upgradeTenantByIdentifier(String tenantIdentifier) throws LiquibaseException {
        upgradeTenant(tenantDetailsService.loadTenantById(tenantIdentifier));
    }
