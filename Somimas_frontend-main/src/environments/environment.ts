...
export const environment = {
  ...
  controlPlaneApiUrl: loadedEnv.controlPlaneApiUrl || window.location.origin + '/saas-api',
  saasMode: loadedEnv.saasMode !== undefined ? loadedEnv.saasMode === true || loadedEnv.saasMode === 'true' : true,
  serverUrl: '',
  ...
  tenantLogoUrl: loadedEnv.tenantLogoUrl || 'assets/images/somimas-logo.png',
